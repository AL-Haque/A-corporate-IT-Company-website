    ...
    <ul class="nav" >
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('dashboard') }}">
                <i class="fa-solid fa-gauge" style="margin-right: 1.4rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('company.index') }}">
                <i class="fa-regular fa-id-card" style="margin-right: 1.4rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('text.index') }}">
                <i class="fa-regular fa-star" style="margin-right: 1.4rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('client.index') }}">
                <i class="fa-solid fa-circle-user" style="margin-right: 1.4rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('ProductFeature.index') }}">
                <i class="fa-solid fa-bars-progress" style="margin-right: 1.4rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('service.index') }}">
                <i class="fa-brands fa-servicestack" style="margin-right: 1.4rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('ServiceDev.index') }}">
                <i class="fa-solid fa-gears" style="margin-right: 1.2rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('servicefeature.index') }}">
                <i class="fa-brands fa-uncharted" style="margin-right: 1.6rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('project.index') }}">
                <i class="fa-regular fa-circle-info" style="margin-right: 1.6rem"></i>
                <span class="menu-title">Project Info</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('otherproject.index') }}">
                <i class="fa-solid fa-sitemap"  style="margin-right:1.2rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('pricing.index') }}">
                <i class="fa-solid fa-money-bill" style="margin-right: 1.2rem"></i>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('map.index') }}">
                <i class="fa-regular fa-map" style="margin-right: 1.3rem"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('question.index') }}">
                <i class="fa-solid fa-circle-question" style="margin-right: 1.3rem"></i>
