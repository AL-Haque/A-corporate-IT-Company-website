    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action=" {{ route('question.update', $questions->id) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" value="{{ $questions->name }}" name="name" class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <textarea class="summernote" name="details">{!! $questions->details !!} </textarea>
                                    </div>
                                </div>
                            </div>
                    </div>
