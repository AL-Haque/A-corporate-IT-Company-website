...
@section('content')
    ...
    <div class="content-wrapper">
        <h2 class="card-title">UPLOAD PRODUCT FEATURESS</h2>

        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action=" {{ route('ProductFeature.update', $products->id) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        ...
                                        <textarea class="summernote" name="details">{!! $products->details !!} </textarea>
                                    </div>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <td><a href="{{ route('ProductFeature.delete', $item->id) }}"><i
